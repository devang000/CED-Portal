...
<head>
	...
	<script>
		...
		document.getElementById("emv");
		var mailformat = /^\w+([\.-]?\w+)*@\w+([\.-]?\w+)*(\.\w{2,3})+$/;
		if(emv.value.match(mailformat))
		{
			...
			<div class="ttr-logo-box">
				<div>
					<a href="index.html" class="ttr-logo">
						<img alt="" class="ttr-logo-mobile" src="assets/images/logo-mobile.png" width="100" height="30">
				...
				<ul>
					<li>
						<a href="index.html" class="ttr-material-button">
		                	...
		                	<span class="ttr-label">Master</span>
		                </a>
		            </li>
					<li>
						<a href="Attandence.html" class="ttr-material-button">
							<span class="ttr-icon"><i class="ti-book"></i></span>
		                	<span class="ttr-label">Attandence</span>
		                </a>
		            </li>
	...
	<main class="ttr-wrapper">
		<div class="container-fluid">
			<div class="db-breadcrumb">
				<h4 class="breadcrumb-title">Report</h4>
                ...
                <div class="row">
					<div class="col-lg-5 col-md-5 m-b30">
						<div class="bg-primary text-white contact-info-bx">
							<h2 class="m-b10 title-head">Report</h2>
							<div class="widget widget_getintuch">	
								<ul>
									<li>To upload your File:-</li>
									<li>Step 1:-Click Browser to select and upload your file</li>
								    <li>Step 2:-Search your file from your computer</li>
								    <li>Step 3:-Click on open to upload file.</li>
								</ul>
							</div>
					...
					<div class="col-lg-7 col-md-7">
						...
						<div class="ajax-message"></div>
							...
							<div class="row placeani">
								...
								<div class="col-lg-6">
									<div class="form-group">
										<div class="input-group"> 
											...
											<input name="email" type="email" id="emv" class="form-control" required="" >
										</div>
									</div>
								</div>
								<!--<div class="col-lg-6">
								...
								<div class="col-lg-12">
									<button name="submit" type="submit" value="Submit" onclick="ValidateEmail();" class="btn button-md"> Send Report</button>
								</div>
							</div>
						</form>
					</div>
